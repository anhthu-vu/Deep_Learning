In this practical session, I implemented different types of RNNs from sratch, and then used them to build and train various models for generating text of variable lengths. To be specific:
